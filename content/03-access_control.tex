...
\begin{center}
    \includegraphics[width=.5\linewidth]{03-access_control/access_control}
    \vspace{-8pt}
\end{center}
...
\includegraphics[width=.7\linewidth]{03-access_control/bell_lapadula}
\begin{itemize}
...
\includegraphics[width=.7\linewidth]{03-access_control/biba}
...
\begin{center}
    \includegraphics[width=1.0\linewidth]{03-access_control/dac}
    \vspace{-8pt}
\end{center}
...
\begin{center}
    \includegraphics[width=1.0\linewidth]{03-access_control/rbac}
    \vspace{-8pt}
\end{center}
...
\begin{center}
    \includegraphics[width=.6\linewidth]{03-access_control/abac}
    \vspace{-8pt}
\end{center}
...
\begin{center}
    \includegraphics[width=.9\linewidth]{03-access_control/acl_trustchain}
    \vspace{-8pt}
\end{center}

\subsubsection{ABAC Trust Chain}
\begin{center}
    \includegraphics[width=1.0\linewidth]{03-access_control/abac_trustchain}
    \vspace{-8pt}
\end{center}
