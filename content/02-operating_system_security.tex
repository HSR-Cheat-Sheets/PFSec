...
\begin{center}
    \vspace{-8pt}
    \includegraphics[width=1.0\linewidth]{02-operating_system_security/system_security_planning}
    \vspace{-8pt}
\end{center}
...
\begin{center}
    \vspace{-8pt}
    \includegraphics[width=1.0\linewidth]{02-operating_system_security/backup}
    \vspace{-8pt}
\end{center}
...
\begin{minipage}{0.45\linewidth}
    \begin{center}
        \includegraphics[width=0.4\linewidth]{02-operating_system_security/virtualization}
        \vspace{-8pt}
    \end{center}
\end{minipage}
...
\begin{center}
    \includegraphics[width=.9\linewidth]{02-operating_system_security/virtual_fw}
    \vspace{-8pt}
\end{center}
